...
SELECT *
FROM PLAYER 
WHERE POSITION = 'GK' AND TEAM_ID  IN (SELECT TEAM_ID FROM PLAYER p WHERE TEAM_ID = 'K01');
...
SELECT *
FROM PLAYER
WHERE TEAM_ID IN (SELECT TEAM_ID FROM PLAYER p WHERE PLAYER_NAME = '정남일'); 
